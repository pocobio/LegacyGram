from typing import Any, Union, List, Callable, TypeVar, Generic, Sequence
...
class jarray(Sequence[T], Generic[T]):
    ...
    def __call__(self, data: Union[List[T], int]) -> 'jarray[T]': ...
...
def static_proxy(extends: Any = None, *implements: Any, package: str = None, modifiers: str = 'public') -> Any:
    """Use as first base class for static proxy generation."""
    ...

# Decorators
def method(return_type: Any, arg_types: List[Any], *, modifiers: str = 'public',
           throws: List[Any] = None) -> Callable: ...

def Override(return_type: Any, arg_types: List[Any], *, modifiers: str = 'public',
             throws: List[Any] = None) -> Callable: ...

def constructor(arg_types: List[Any], *, modifiers: str = 'public', throws: List[Any] = None) -> Callable: ...